  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all duration-250 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        accent:
          "bg-accent-500 text-white hover:bg-accent-600 hover:shadow-accent-glow",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border-2 border-navy-800 bg-transparent text-navy-800 hover:bg-navy-800 hover:text-white",
        "outline-accent":
          "border-2 border-accent-500 bg-transparent text-accent-500 hover:bg-accent-500 hover:text-white",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost:
          "hover:bg-navy-50 hover:text-navy-800",
        link:
          "text-accent-500 underline-offset-4 hover:underline p-0 h-auto",
      },
      size: {
